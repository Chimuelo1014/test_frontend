...
const Login = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    // Aquí irá la integración con Google OAuth
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-border dark:border-slate-700 p-6 md:p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 md:py-3 border-2 border-border dark:border-slate-700 rounded-lg font-medium text-text dark:text-white hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors mb-6"
          >
